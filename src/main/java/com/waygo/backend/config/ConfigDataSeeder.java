    ...
    private void seedTariffPlans() {
        if (tariffPlanRepository.count() == 0) {
            TariffPlan t1 = TariffPlan.builder()
                ...
                .description("24 soat davomida limitsiz buyurtmalar oling va 0% komissiya bilan ishlang.")
            ...
            TariffPlan t3 = TariffPlan.builder()
                ...
                .description("3 kun davomida komissiyasiz va qulay shartlarda buyurtmalardan bahramand bo'ling.")
            ...
            TariffPlan t7 = TariffPlan.builder()
                ...
                .description("1 hafta davomida komissiyasiz ishlash, katta chegirmalar va cheksiz buyurtmalar.")
            ...
            TariffPlan t15 = TariffPlan.builder()
                ...
                .description("15 kun davomida limitsiz buyurtmalar, yuqori ustuvorlik va har bir buyurtmada ko'proq daromad.")
            ...
            TariffPlan t30 = TariffPlan.builder()
                ...
                .description("Maksimal chegirma va premium status bilan 30 kun davomida eng arzon narxda ishlang.")
