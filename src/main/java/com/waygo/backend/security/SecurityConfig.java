...
public class SecurityConfig {
        ...
        http
            ...
            .authorizeHttpRequests(auth -> auth
                .requestMatchers(
                    ...
                    "/api/v1/payments/multicard/callback",
                    "/api/v1/payments/paynet/uws",
                    "/api/v1/payments/paynet/check",
                    "/api/v1/payments/paynet/deposit",
                    "/api/v1/config/**",
                    "/api/v1/tariffs/vip-chat/webhook"
                ).permitAll()
    ...
    public SecurityFilterChain adminFilterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                .requestMatchers("/", "/css/**", "/js/**", "/images/**", "/favicon.ico", "/payment-success", "/admin/login", "/admin/forgot-password", "/admin/reset-password", "/uploads/**").permitAll()
